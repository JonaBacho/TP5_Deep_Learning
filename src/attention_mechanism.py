...
def exercise_1_basic_attention():
    ...
    with mlflow.start_run(run_name="Ex1_GRU_Attention"):
        ...
        for epoch in range(len(history.history['loss'])):
            ...
            mlflow.log_metric("train_accuracy", history.history['dense_1_accuracy'][epoch], step=epoch)
            mlflow.log_metric("val_loss", history.history['val_loss'][epoch], step=epoch)
            mlflow.log_metric("val_accuracy", history.history['val_dense_1_accuracy'][epoch], step=epoch)
